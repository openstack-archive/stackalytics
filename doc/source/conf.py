...
sys.path.insert(0, os.path.abspath('../../stackalytics'))
...
#
# Version info
from stackalytics.version import version_info as stackalytics_version
release = stackalytics_version.release_string()
# The short X.Y version.
version = stackalytics_version.version_string()
...
htmlhelp_basename = 'StackalyticsDoc'
